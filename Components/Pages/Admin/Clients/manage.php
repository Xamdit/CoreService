                ...
                <div class="_buttons">
                    ...
                    <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip"
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                            ...
                            <?php if (db.get_option('customer_requires_registration_confirmation') == '1' || total_rows( 'clients', 'registration_confirmed=0') > 0) { ?>
                            <li class="divider"></li>
                            <li>
                ...
                <div class="panel_s tw-mt-2 sm:tw-mt-4">
                    <div class="panel-body">
                      ...
                      if (!has_permission('customers', '', 'view')) {
                          $where_summary = ' AND userid IN (SELECT customer_id FROM ' .  'customer_admins WHERE staff_id=' . get_staff_user_id() . ')';
                      } ?>
                        <div class="mbot15">
                            ...
                            <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-6 tw-gap-2">
                                <div
                                    ...
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php echo total_rows( 'clients', ($where_summary != '' ? substr($where_summary, 5) : '')); ?>
                                    </span>
                                    <span
                                ...
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php echo total_rows( 'clients', 'active=1' . $where_summary); ?></span>
                                    <span
                                ...
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php echo total_rows( 'clients', 'active=0' . $where_summary); ?></span>
                                    <span
                                ...
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php echo total_rows( 'contacts', 'active=1' . $where_summary); ?>
                                    </span>
                                    <span
                                ...
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php echo total_rows( 'contacts', 'active=0' . $where_summary); ?>
                                    </span>
                                    <span
                                ...
                                <div
                                    ...
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php echo total_rows( 'contacts', 'last_login LIKE "' . date('Y-m-d') . '%"' . $where_summary); ?>
                                    </span>
