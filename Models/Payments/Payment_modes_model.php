...
class Payment_modes_model extends App_Model
{
    ...
    public function get($id = '', $where = [], $include_inactive = false, $force = false)
    {
        ...
        $modes = $this->db->get( 'payment_modes')->result_array();
    ...
    public function delete($id)
    {
        ...
        if (is_reference_in_table('paymentmode',  'invoicepaymentrecords', $id)
            || is_reference_in_table('paymentmode',  'expenses', $id)) {
            return [
                'referenced' => true,
            ];
        }
