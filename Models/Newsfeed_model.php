...
class Newsfeed_model extends App_Model
{
    ...
    {
        $this->db->select();
        $this->db->from( 'newsfeed_post_likes');
        $this->db->join( 'staff',  'staff.staffid = ' .  'newsfeed_post_likes.userid', 'left');
    ...
    public function load_likes_modal($offset, $postid)
    {
        ...
        return $this->db->get( 'newsfeed_post_likes')->result_array();
    }
    ...
    public function load_comment_likes_model($offset, $commentid)
    {
        ...
        return $this->db->get( 'newsfeed_comment_likes')->result_array();
    }
    ...
    public function load_newsfeed($offset, $post_id = '')
    {
        ...
        return $this->db->get( 'newsfeed_posts')->result_array();
    }
    ...
    public function get_post($id)
    {
        ...
        return $this->db->get( 'newsfeed_posts')->row();
    }
    ...
    public function get_comment($id, $return_as_array = false)
    {
        ...
        if ($return_as_array == false) {
            return $this->db->get( 'newsfeed_post_comments')->row();
        }

        return $this->db->get( 'newsfeed_post_comments')->row_array();
    }
    ...
    public function add($data)
    {
        ...
        $this->db->insert( 'newsfeed_posts', $data);
    ...
    public function like_post($id)
    {
        ...
        $this->db->insert( 'newsfeed_post_likes', [
            'postid'    => $id,
    ...
    public function user_liked_post($id)
    {
        ...
        return $this->db->get( 'newsfeed_post_likes')->row();
    }
    ...
    public function user_liked_comment($id)
    {
        ...
        return $this->db->get( 'newsfeed_comment_likes')->row();
    }
    ...
    public function add_comment($data)
    {
        ...
        $data['content']   = nl2br($data['content']);
        $this->db->insert( 'newsfeed_post_comments', $data);
    ...
    public function like_comment($id, $postid)
    {
        ...
        $data['commentid'] = $id;
        $data['postid']    = $postid;
        $this->db->insert( 'newsfeed_comment_likes', $data);
        if ($this->db->affected_rows() > 0) {
    ...
    public function remove_post_comment($id, $postid)
    {
        ...
        if (total_rows( 'newsfeed_post_comments', [
            'postid' => $postid,
            'userid' => get_staff_user_id(),
            'id' => $id,
        ]) > 0) {
            ...
            $this->db->where('postid', $postid);
            $this->db->where('userid', get_staff_user_id());
            $this->db->delete( 'newsfeed_post_comments');
            if ($this->db->affected_rows() > 0) {
                return true;
            }
    ...
    public function delete_post($postid)
    {
        ...
        if (total_rows( 'newsfeed_posts', [
            'postid' => $postid,
            'creator' => get_staff_user_id(),
        ]) > 0 || is_admin()) {
            $this->db->where('postid', $postid);
            $this->db->delete( 'newsfeed_posts');
            if ($this->db->affected_rows() > 0) {
                $this->db->where('postid', $postid);
                $this->db->delete( 'newsfeed_post_likes');
    ...
    public function get_post_comments($postid, $offset)
    {
        ...
        return $this->db->get( 'newsfeed_post_comments')->result_array();
    }
}
